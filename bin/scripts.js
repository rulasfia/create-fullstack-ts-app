 ...
 * @param {string} dir - project directory
 */
const cleanupCommand = (dir) => `cd ${dir} && npx shx rm -rf ./bin && npx shx rm -rf .git`;
 ...
 * @param {string} dir - project directory
 */
const postInstallCommnad = (dir) => `cd ${dir}/apps/server/prisma && npx shx touch database.db && cd .. && npx prisma migrate dev --name init && npx prisma generate`;
